...
class MedicoRepositoryTest {
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario1() {
        ...
        //given. Dados los valores iniciales
        var proximoLunes10H = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10,0);

        var medico = registrarMedico("Papalote", "papa@email.com", "12345678", Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Chunchula", "chunchu@email.com", "6543218");

        registrarConsulta(medico,paciente,proximoLunes10H);

        //when. Cuando se da la buscqueda
        var medicoLibre = medicoRepository.seleccionarMedicoConEspecialidadEnFecha(Especialidad.CARDIOLOGIA,proximoLunes10H);

        //then. Recibir un resultado
